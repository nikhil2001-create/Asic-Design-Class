...
![image](https://github.com/user-attachments/assets/e9009f09-741a-4f6c-bf75-14010ee250c0)

• **CLK:** Represents the output clock signal generated by the PLL module.

• **clk_nik:** The clock signal utilized by the RISC-V CPU for its operations.

• **reset:** The signal used to reset the RISC-V CPU.

• **REF:** The reference clock signal provided as input to the PLL module.

• **OUT:** The output signal from the Digital-to-Analog Converter (DAC).
</details>
